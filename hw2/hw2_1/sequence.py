...
if __name__ == "__main__":
    ...
    print("video ID:", vid_id[44])
    print("Features:", ID_caption[44][0].shape)
    print("Caption:", ID_caption[44][1])
   
    print("caption details")
    print("Caption:", np.shape(ID_caption))
    print("Caption's max length:", max_captions_length)
    print("Average length of the captions:", avg_captions_length)
    print("Total no of Unique tokens:", num_unique_tokens_captions)
